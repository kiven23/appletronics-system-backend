...
(1, 'CARIAZO', 'DANICA', 'LALOGAN', 'Adams (Pob.)', 'N/A', '9215647896', 'null', '265', 'Adams', 'undefined', 'Ilocos Norte', 'undefined', 'ALEJO ST', '09914785623', '2023-01-21 05:10:23', '2023-01-21 05:10:23'),
(2, 'steven', 'calimlim', 'fernanadez', 'Angas', 'linuxwalk', '9123232323', 'calimlim.steven@gmail.com', NULL, 'Basud', NULL, 'Camarines Norte', NULL, NULL, NULL, '2023-01-21 06:07:52', '2023-01-21 06:07:52'),
(3, 'KRISTAL', 'LABASAN', 'TAN', 'Poblacion East', 'N/A', '9562847521', NULL, 'N/A', 'Asingan', '1', 'Pangasinan', '3 UNIT HS-09ISY', 'N/A', '09235641234', '2023-01-21 07:30:31', '2023-01-21 07:30:31'),
(4, 'steven', 'calimlim', 'fernandez', 'Baybayog', 'linuxwalk', '9153343434', 'calimlim.steven@gmail.com', NULL, 'Alcala', NULL, 'Cagayan', '1 pcs', NULL, '34234564', '2023-01-21 08:45:46', '2023-01-21 08:45:46');
...
(1, 'DANICA', 'CARIAZO', 'LALOGAN', 'Afusing Bato', 'N/A', '9215647896', 'test', '265', 'Alcala', 'undefined', 'Cagayan', 'undefined', 'ALEJO ST', '09914785623', '2023-01-21 05:12:49', '2023-01-21 05:12:49'),
(2, 'steven', 'calimlim', 'fernanadez', 'Angas', 'linuxwalk', '9123232323', 'calimlim.steven@gmail.com', NULL, 'Basud', NULL, 'Camarines Norte', NULL, NULL, NULL, '2023-01-21 06:07:52', '2023-01-21 06:07:52'),
(3, 'KRISTAL', 'LABASAN', 'TAN', 'Poblacion East', 'N/A', '9562847521', NULL, 'N/A', 'Asingan', '1', 'Pangasinan', '3 UNIT HS-09ISY', 'N/A', '09235641234', '2023-01-21 07:30:31', '2023-01-21 07:30:31'),
(4, 'steven', 'calimlim', 'fernandez', 'Baybayog', 'linuxwalk', '9153343434', 'calimlim.steven@gmail.com', NULL, 'Alcala', NULL, 'Cagayan', '1 pcs', NULL, '34234564', '2023-01-21 08:45:46', '2023-01-21 08:45:46');
...
--
-- Table structure for table `bk_notifies`
--

CREATE TABLE `bk_notifies` (
  `id` int(10) UNSIGNED NOT NULL,
  `bsender_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `breceiver_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `event_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `status` varchar(233) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `event_logs` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `bk_requests` (
  ...
  `ticketno` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `bk_requests` (`id`, `requestid`, `requesttype`, `customerid`, `branch`, `userid`, `unitid`, `attachment`, `additionalrequest1`, `additionalrequest2`, `specialinstruction`, `created_at`, `updated_at`, `status`, `identify`, `bookby`, `locandorg`, `organizationname`, `surveyloc`, `callid`, `installer`, `installationdate`, `ticketno`, `landmark`) VALUES
(1, 'REF-INSTALLATION-165950', 'INSTALLATION', '1', '5', '1609', '2df4997b92712077e34234c6c59d8581', '', 'undefined', 'undefined', 'undefined', '2023-01-21 05:12:49', '2023-01-21 05:44:01', '1', 'INSTALLATION/5/1609', 'undefined', 'undefined', 'undefined', 'undefined', '34234', 'Mike Doe', '2023-01-20', 'APPL-000001', 'undefined'),
(2, 'REF-REPAIR-202066', 'REPAIR', '2', '5', '1609', '8f89a54ed5c59f16761274e4b4f32afb', '', NULL, NULL, NULL, '2023-01-21 06:07:52', '2023-01-21 06:08:28', '1', 'REPAIR/5/1609', NULL, NULL, 'undefined', 'undefined', '34323', 'Mike Doe', '2023-01-20', 'APPL-000002', 'undefined'),
(3, 'REF-INSTALLATION-339629', 'INSTALLATION', '3', '2', '1616', '34a5495682be772da4e72576a20c2d11', 'BookingSystemAttachments/mO8Mch9skmvsnNY9qYscKAxJzJBssmKCAl79gj38.pdf', NULL, NULL, '3 UNIT HS-09ISY', '2023-01-21 07:30:31', '2023-01-21 07:42:33', '1', 'INSTALLATION/2/1616', NULL, NULL, 'MUNICIPALITY OF ASINGAN', 'undefined', '123456', NULL, NULL, 'AGOO-000003', 'NEAR AT POLICE STATION'),
(4, 'REF-REPAIR-873226', 'REPAIR', '4', '9', '1618', 'eea2512b8a067d6cf15313d298667b4b', '', NULL, NULL, '1 pcs', '2023-01-21 08:45:46', '2023-01-21 08:45:46', '0', 'REPAIR/9/1618', NULL, NULL, 'undefined', 'undefined', NULL, NULL, NULL, 'BALIUAG-000004', 'landmark');
...
CREATE TABLE `bk_scalate_updates` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `from_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `bk_units` (
  ...
  `withpowersupply` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
(1, 'SIDE BY SIDE', 'N/A', 'PANASONIC', '2023-01-21', '2023-01-19', '', '', '', 'Adams (Pob.),Adams,Ilocos Norte', '10R-A7413E', '3423', 'MEDIUM', 'REFRIGERATOR', NULL, '1', '', '05:03', 'REPO', 'COMMERCIAL', 'WARRANTY', 'N/A', '2023-01-21 05:10:23', '2023-01-21 05:10:23', '8423d825f7ea4c484122a175e4eccb67', '3434', NULL),
(2, 'N/A', 'N/A', 'WHIRLPOOL', '2023-01-21', '2023-01-26', '', '', '', 'Afusing Bato,Alcala,Cagayan', '1CWGD5700', '232', '', 'GAS DRYER', NULL, '', '', '01:02', 'BRAND NEW', 'COMMERCIAL', 'OUT WARRANTY', 'N/A', '2023-01-21 05:12:49', '2023-01-21 05:12:49', '2df4997b92712077e34234c6c59d8581', '22', NULL),
(3, 'TWO DOOR', NULL, 'PANASONIC', '2023-01-21', NULL, '', NULL, NULL, 'Angas,Basud,Camarines Norte', '10R-A7413E', NULL, 'MEDIUM', 'REFRIGERATOR', NULL, '', '', ':', 'REPO', NULL, 'WARRANTY', NULL, '2023-01-21 06:07:52', '2023-01-21 06:07:52', '8f89a54ed5c59f16761274e4b4f32afb', NULL, 'NOT HEATING'),
(4, 'SPLIT TYPE AIRCON - INVERTER', 'N/A', 'SHARP', '2023-01-19', '', '', '', '', 'POBLACION EAST ASINGAN PANGASINAN', 'AH-X10ZF', '5000', 'HIGH', 'AIRCON', NULL, '', '1234526', ':', 'BRAND NEW', 'COMMERCIAL', 'WARRANTY', 'N/A', '2023-01-21 07:30:31', '2023-01-21 07:30:31', '34a5495682be772da4e72576a20c2d11', '04562', NULL),
(5, 'FULLY AUTOMATIC', NULL, 'WHIRLPOOL', '2023-01-21', NULL, '', NULL, NULL, 'Baybayog,Alcala,Cagayan', '4GWTW3000FW', NULL, 'MEDIUM', 'WASHING MACHINE', NULL, '', '2324353453', ':', 'REPO', NULL, 'OUT WARRANTY', NULL, '2023-01-21 08:45:46', '2023-01-21 08:45:46', 'eea2512b8a067d6cf15313d298667b4b', NULL, 'NOT DRAINING');
...
CREATE TABLE `branches` (
  ...
  `seriesname` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('AGOO-LU', 2, 141, 1, 9, 'Agoo', 'AGOO', 'Albert Quilondrino', 4, NULL, '2023-01-20 06:29:40', '034', 'AGOO'),
('ALAM-PN', 3, 108, 1, 9, 'Alaminos', 'ALAM', 'Richard Mariano', 3, NULL, '2023-01-20 06:05:11', '032', 'ALAMINOS'),
('APAL-PM', 4, 114, NULL, 11, 'Apalit', 'APLT', 'Donard Dale Tabinas', 8, NULL, '2023-01-20 07:18:40', '042', 'APALIT'),
('APPL-PN', 5, 148, 0, 2, 'Appletronics Main Office', 'APPL2', 'Arnel Salagubang', 1, NULL, '2019-10-30 19:27:17', '059', 'APPL'),
(NULL, 6, 999, NULL, 10, 'Appletronics Santiago', 'APLS', 'John Doe', NULL, NULL, '2023-01-20 07:22:38', '059', 'APPL'),
('BAGU-BN', 7, 115, NULL, 9, 'Baguio', 'BAGU', 'Elenita Parazo', 4, NULL, '2023-01-20 06:30:05', '013', 'BAGUIO'),
('BALA-BT', 8, 144, NULL, 11, 'Balanga', 'BALA', 'Christian Paul', 9, NULL, '2023-01-20 07:20:40', '051', 'BALANGA'),
('BALI-BL', 9, 137, NULL, 11, 'Baliuag', 'BALI', 'Philip Baylon', 8, NULL, '2023-01-20 07:19:04', '044', 'BALIUAG'),
('BANT-SR', 10, 116, NULL, 9, 'Bantay', 'BANT', 'Etelyn Tagayuna', 6, NULL, '2023-01-20 06:30:33', '016', 'BANTAY'),
('BATA-NR', 11, 117, NULL, 9, 'Batac', 'BATC', 'Mark Leo Rabbon', 5, NULL, '2023-01-20 06:30:43', '028', 'BATAC'),
('BAYA-PN', 12, 109, NULL, 9, 'Bayambang', 'BAYA', 'Fedema Rivera', 3, NULL, '2023-01-20 06:28:55', '033', 'BAYAMBAN'),
('CAMI-TR', 13, 118, NULL, 10, 'Camiling', 'CMLG', 'Ma. Catherine Valdez', 10, NULL, '2023-01-20 07:17:28', '024', 'CAMILING'),
('CAND-SR', 14, 119, NULL, 9, 'Candon', 'CAND', 'Leo Baliton', 4, NULL, '2023-01-20 06:30:26', '014', 'CANDON'),
('CAPA-TR', 15, 120, NULL, 10, 'Capas', 'CAPA', 'Alma Joy Casoy', 10, NULL, '2023-01-20 07:18:03', '029', 'CAPAS'),
('CAUA-IA', 16, 121, NULL, 10, 'Cauayan', 'CAUA', 'Michael Iris Grande', 7, NULL, '2023-01-20 06:32:30', '040', 'CAUAYAN'),
('DAGU-PN', 17, 112, NULL, 9, 'Dagupan', 'DAGU', 'Rhodora Pedro', 3, NULL, '2023-01-20 06:29:03', '006', 'DAGUPAN'),
('IBAZ-ZM', 18, 143, NULL, 11, 'Iba', 'IBAZ', 'Armando Jr. Ochua', 9, NULL, '2023-01-20 07:20:54', '050', 'IBA'),
('ILAG-IA', 19, 145, NULL, 10, 'Ilagan', 'ILAG', 'Kevin Jasper Magno', 5, NULL, '2023-01-20 06:32:54', '052', 'ILAG'),
('LAOA-NR', 20, 122, NULL, 9, 'Laoag', 'LAOA', 'Osborne Dela Cruz', 5, NULL, '2023-01-20 06:30:51', '015', 'LAOAG'),
('MABA-PM', 21, 123, NULL, 11, 'Mabalacat', 'MABA,MABI', 'Regina Rabang', 8, NULL, '2023-01-20 07:18:19', '031', 'BALA'),
('MANA-PN', 22, 111, NULL, 9, 'Manaoag', 'MANA', 'Caroline Operaña', 3, NULL, '2023-01-20 06:29:10', '008', 'MANAOAG'),
('MANG-PN', 23, 110, NULL, 9, 'Mangaldan', 'MANG', 'Roselida Manaois', 3, NULL, '2023-01-20 06:29:16', '007', 'MANGALDN'),
('MONC-TR', 24, 124, NULL, 10, 'Moncada', 'MONC', 'Marilou Mauricio', 10, NULL, '2023-01-20 07:16:59', '019', 'MONCADA'),
('NAGU-LU', 25, 136, NULL, 9, 'Naguilian', 'NAGU', 'Lanilyn Edna Florendo', 4, NULL, '2023-01-20 06:29:58', '012', 'NAGU'),
('NANC-PN', 26, 105, NULL, 8, 'Nancayasan', 'NANC', 'Rhodora Cancino', 1, NULL, '2023-01-20 05:59:35', '027', 'NANC'),
(NULL, 27, 155, NULL, 8, 'Appletronics-Addessa', 'APPL', 'Arnel Salagubang', 1, NULL, '2023-01-20 07:21:24', '059', 'APPL'),
('PANI-TR', 28, 125, NULL, 10, 'Paniqui', 'PANI', 'Leslie Soliman', 10, NULL, '2023-01-20 07:17:07', '017', 'PANIQUI'),
('POZO-PN', 29, 126, NULL, 8, 'Pozorrubio', 'POZO', 'Lowella Perez', 1, NULL, '2023-01-20 05:59:23', '009', 'PZRRUBIO'),
('ROSA-PN', 30, 107, NULL, 8, 'Rosales', 'ROSS', 'Imelda Mones', 1, NULL, '2023-01-20 06:01:13', '004', 'ROSALES'),
('ROSA-LU', 31, 127, NULL, 9, 'Rosario', 'ROSO', 'Ailen Jucar', 4, NULL, '2023-01-20 06:29:32', '010', 'ROSARIO'),
('ROXA-IA', 32, 140, NULL, 10, 'Roxas', 'ROXA', 'Charisse Sales', 7, NULL, '2023-01-20 06:32:46', '048', 'ROXA'),
('SANC-PN', 33, 129, NULL, 9, 'San Carlos', 'SNCA', 'Edward Gallarin', 3, NULL, '2023-01-20 06:28:46', '043', 'SNCARLOS'),
('SANF-LU', 34, 128, NULL, 9, 'San Fernando', 'SFLU', 'Clarisa Ugma', 4, NULL, '2023-01-20 06:29:52', '011', 'SANFRNDO'),
('SANJ-NE', 35, 130, NULL, 10, 'San Jose', 'SNJO,EASY', 'Rose Marie Espiritu', 7, NULL, '2023-01-20 07:17:22', '002', 'SNJO'),
('SANC-CG', 36, 142, NULL, 9, 'Sanchez Mira', 'SANC', 'Manolito Bonifacio Leonador', 5, NULL, '2023-01-20 06:30:57', '049', 'SANC'),
('SANT-SR', 37, 134, NULL, 9, 'Santa Cruz', 'STCR', 'Irene Lolie Abajo', 4, NULL, '2023-01-20 06:30:19', NULL, 'MANGATAR'),
('STAM-BL', 38, 149, NULL, 11, 'Santa Maria', 'STAM', 'Frankie Viernes', 8, NULL, '2023-01-20 07:18:57', NULL, 'MARI'),
('SANT-IA', 39, 131, NULL, 10, 'Santiago', 'STGO', 'Dikela Managad', 7, NULL, '2023-01-20 06:32:12', '041', 'SANTIAGO'),
('SIND-PM', 40, 132, NULL, 11, 'Sindalan', 'SIND', 'Frederick Taylan', 9, NULL, '2023-01-20 07:18:33', '035', 'SINDALAN'),
('SOLA-NV', 41, 135, NULL, 10, 'Solano', 'SOLA', 'Josen Bautista', 7, NULL, '2023-01-20 06:31:59', '046', 'SOLANO'),
('TARL-TR', 42, 133, NULL, 10, 'Tarlac', 'TARL', 'Raquel Sarguet', 10, NULL, '2023-01-20 07:17:34', '018', 'TARLAC'),
('TAYU-PN', 43, 113, NULL, 8, 'Tayug', 'TAYU', 'Rose Ann Bugarin', 1, NULL, '2023-01-20 06:01:28', '005', 'TAYUG'),
('TUGU-CG', 44, 139, NULL, 10, 'Tuguegarao', 'TUGU', 'Charince Parajas', 5, NULL, '2023-01-20 06:35:37', '047', 'TUGU'),
('TUMA-IA', 45, 147, NULL, 10, 'Tumauini', 'TUMA', 'Marcelino Lazo Jr.', 5, NULL, '2023-01-20 06:33:03', '054', 'TUMAUINI'),
('UMIN-PN', 46, 138, NULL, 8, 'Umingan', 'UMIN', 'Mary Ann Tolentino', 1, NULL, '2023-01-20 06:01:38', '037', 'UMINGAN'),
('URDA-PN', 47, 104, NULL, 8, 'Urdaneta', 'URDA,URD2', 'Joan Laulita', 1, NULL, '2023-01-20 05:58:47', '002', 'URDAALEX'),
('VILL-PN', 48, 106, NULL, 8, 'Villasis', 'VILL', 'Mariles Dela Cruz', 1, NULL, '2023-01-20 05:59:48', '003', 'VILLASIS'),
('BAMB-NV', 50, 146, NULL, 10, 'Bambang', 'BAMB', 'Verylie Ann Martinez', 7, '2018-10-21 18:29:12', '2023-01-20 06:31:50', '053', 'BAMB'),
('BUNT-CG', 51, 151, NULL, 10, 'Buntun', 'BUNT', 'Jessica Amor', 5, '2018-10-31 12:06:43', '2023-01-20 06:35:31', '057', 'BUNT'),
('MAGA-PM', 52, 152, NULL, 11, 'Magalang', 'MAGA', 'Mariel Baoanin', 8, '2018-10-31 12:07:53', '2023-01-20 07:18:11', '056', 'MAGA'),
('MALO-BL', 53, 150, NULL, 11, 'Malolos', 'MALO', 'Alexander Cunanan', 8, '2018-10-31 12:08:21', '2023-01-20 07:18:47', '062', 'MALO'),
('SUBI-ZM', 54, 153, NULL, 11, 'Subic', 'SUBI', 'Mc Jeron Caronongan', 9, '2018-12-14 13:46:07', '2023-01-20 07:21:00', '061', 'SUBI'),
(NULL, 57, NULL, NULL, NULL, 'Main Office', NULL, NULL, NULL, '2019-03-12 19:38:41', '2019-03-12 19:38:41', '001', 'MANGATAR'),
('MANM-PN', 58, 900, NULL, 9, 'Mangatarem', 'MANM', 'Eliseo John Buenaventura', 3, '2019-11-11 18:47:30', '2023-01-20 06:28:31', '063', 'MANGATAR'),
('GAPA-NE', 59, 9999, NULL, 10, 'Gapan', 'GAPA', 'Johnlyn Agpoon', 7, '2020-02-13 14:45:46', '2023-01-20 07:17:48', '064', 'GAPA'),
('PAND-PM', 61, 158, NULL, 11, 'Pandan', 'PAND', 'Emerson Villar', 9, '2020-11-05 14:37:35', '2023-01-20 07:18:27', '066', 'PAND'),
('CONC-TR', 62, 157, NULL, 10, 'Concepcion', 'CONC', 'Jesthony Bryan Leysa', 10, '2020-11-05 15:12:04', '2023-01-20 07:17:54', '065', 'CONC'),
('MARI-BT', 63, 581, NULL, 11, 'Mariveles', 'MARI', 'Jerome Salivio', 9, '2020-11-26 13:47:13', '2023-01-20 07:20:47', '067', 'MARI'),
('SANF-PN', 65, 3452, 1, 9, 'San Fabian', 'SANF', 'John Doe', 3, '2021-03-25 15:06:40', '2023-01-20 06:29:25', NULL, 'SANF'),
('LING-PN', 66, 2345, NULL, 9, 'Lingayen', 'LING', 'Nelson G. Serrano', 3, '2021-05-21 18:03:07', '2023-01-20 06:28:38', NULL, 'LING'),
('BINA-PN', 67, 3423, 1, 8, 'Binalonan', 'BINA', 'Danny Quero', 1, '2021-05-31 13:02:35', '2023-01-20 05:58:17', NULL, 'BINALONA'),
('GUIM-NE', 68, 23423, NULL, 10, 'Guimba', 'GUIM', 'John Doe', 7, '2021-05-31 13:03:24', '2023-01-20 07:17:13', '003', 'MANGATAR'),
('ZARA-NE', 70, 567, NULL, 10, 'Zaragoza', 'ZARA', 'Jeffrey Gorospe Pascual', 7, '2022-03-22 18:20:18', '2023-01-20 07:17:42', '004', 'ZARA'),
(NULL, 71, 160, NULL, 9, 'SUAL', 'SUAL', 'Main Office', NULL, '2022-03-26 15:46:21', '2023-01-20 06:28:20', '001', 'SUAL'),
(NULL, 72, 3435253, 2, 9, 'Bolinao', 'BOLI', 'JOHN DOE', NULL, '2023-01-20 06:04:49', '2023-01-20 06:04:49', NULL, NULL),
(NULL, 73, 34544, NULL, 10, 'Cuyapo', 'CUYA', 'James Dew', NULL, '2023-01-20 06:36:16', '2023-01-20 06:36:16', NULL, NULL),
(NULL, 74, 325235, 1, 11, 'San Ildefonso', 'SANIID', 'James Does', NULL, '2023-01-20 07:20:32', '2023-01-20 07:20:32', NULL, NULL);
...
(13, '2023_01_18_142916_create_bk_notifies_table', 3);
...
(263, 'AREA-4', 'web', '2023-01-20 06:25:15', '2023-01-20 06:25:15');
...
(8, 'CALLIN1', NULL, NULL),
(9, 'CALLIN2', NULL, NULL),
(10, 'CALLIN3', NULL, NULL),
(11, 'CALLIN4', NULL, NULL);
...
(89, 'AREA4', 'web', '2023-01-20 06:25:30', '2023-01-21 08:55:57'),
(90, 'Booking Super User', 'web', '2023-01-20 07:34:22', '2023-01-20 07:34:22');
...
(1616, 2, 'James', 'Doe', 'booking_agoo@appletronics.com', '$2y$10$IiXwBo/CIl5JyV9iHUvNkuyQ5SgjGjdueQ65h8yKyEijXFVA0VW/K', NULL, '2023-01-16 07:59:01', '2023-01-16 07:59:01', 1, NULL, NULL, NULL, NULL),
(1617, 4, 'Mike', 'Doe', 'booking_apalit@appletronics.com', '$2y$10$7PBEu3PgZXBKtIN8ax.svO4yHfPMtjEUpVY0rY4xb3iShbLe4tlYq', NULL, '2023-01-16 08:00:47', '2023-01-16 08:00:47', 1, NULL, NULL, NULL, NULL),
(1618, 9, 'JHEM', 'DOE', 'jhemdoe@appletronics.com', '$2y$10$R1ZBe9.6yfrroNP55E0tMOZhs8DA0OEPLtWRn4SgY3uYwdcjWOBKG', NULL, '2023-01-21 08:36:59', '2023-01-21 08:36:59', 1, NULL, NULL, NULL, NULL);
...
(1614, 234234, '1616', NULL, 18, 25, NULL, 2, 0, NULL, NULL, NULL, NULL, '2023-01-16 07:59:01', '2023-01-16 07:59:59', NULL, NULL),
(1615, 34324, '1617', NULL, 18, 25, NULL, 4, 0, NULL, NULL, NULL, NULL, '2023-01-16 08:00:47', '2023-01-19 02:59:32', NULL, NULL),
(1616, 3453, '1618', NULL, 18, 25, NULL, 9, 0, NULL, NULL, NULL, NULL, '2023-01-21 08:36:59', '2023-01-21 08:39:44', NULL, NULL);
...
--
-- Indexes for table `bk_notifies`
--
ALTER TABLE `bk_notifies`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `bk_notifies`
--
ALTER TABLE `bk_notifies`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_employments`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1617;
